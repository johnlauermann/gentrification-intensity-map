...
here::i_am("data_combine_allyears_2020tr.r")
...
st_layers("tract_boundaries.gpkg")
boundaries <- st_read("tract_boundaries.gpkg", layer = "metrotracts_boundaries_2020tr")
...
### remove spatial formatting and save
